/**
 * Preset Tailwind compartilhado pelos apps do monorepo (geo + relat).
 * Contem apenas os tokens de tema (cores, tipografia, espacamento, raios,
 * sombras, alturas de botao). Cada app define seu proprio `content`.
 *
 * Fonte canonica dos tokens: docs/ui/ui-audit-report.md.
 */

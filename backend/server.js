...
const licenseAttachmentsRouter = require('./routes/licenseAttachments');
...
const paecRouter = require('./routes/paec');
...
app.use('/api/licenses', licenseAttachmentsRouter);
